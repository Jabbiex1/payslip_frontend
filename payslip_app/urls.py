...
urlpatterns = [
    ...
    path('frontend-admin/reports/', views.admin_reports, name='admin_reports'),
    ...
    path('frontend-admin/download-logs/', views.download_logs_view, name='admin_download_logs'),
    ...
    path('frontend-admin/mark-completed/<int:pk>/', views.mark_completed, name='mark_completed'),
